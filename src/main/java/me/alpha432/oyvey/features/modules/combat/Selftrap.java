...
public class Selftrap extends Module {
    ...
    private final me.alpha432.oyvey.util.Timer offTimer = new me.alpha432.oyvey.util.Timer();
    private final me.alpha432.oyvey.util.Timer timer = new me.alpha432.oyvey.util.Timer();
    private boolean hasOffhand = false;
    private final Map<BlockPos, Integer> retries = new HashMap<BlockPos, Integer>();
    private final me.alpha432.oyvey.util.Timer retryTimer = new Timer();
