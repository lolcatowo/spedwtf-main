...
public class Speedmine extends Module {
    ...
    public void onRender3D(Render3DEvent event) {
        if (render.getValue().booleanValue() && currentPos != null && currentBlockState.getBlock() == Blocks.OBSIDIAN) {
            Color color = new Color(timer.passedMs((int) (2000.0f * Sped.serverManager.getTpsFactor())) ? 0 : 255, timer.passedMs((int) (2000.0f * Sped.serverManager.getTpsFactor())) ? 255 : 0, 0, 255);
