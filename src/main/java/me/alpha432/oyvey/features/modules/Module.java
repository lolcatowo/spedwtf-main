...
public abstract class Module
    ...
    public void enable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            TextComponentString text = new TextComponentString(Sped.commandManager.getClientMessage() + " " + ChatFormatting.DARK_GRAY + getDisplayName() + " " + "toggled " + ChatFormatting.GREEN + "on" );
    ...
    public void disable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            TextComponentString text = new TextComponentString(Sped.commandManager.getClientMessage() + " " + ChatFormatting.DARK_GRAY + getDisplayName() + " " + "toggled " + ChatFormatting.RED + "off" );
            Module.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(text, 1);
        }
        this.onToggle();
        this.onDisable();
    ...
    public void setDisplayName(String name) {
        Module module = Sped.moduleManager.getModuleByDisplayName(name);
        Module originalModule = Sped.moduleManager.getModuleByName(name);
    ...
    public String getFullArrayString() {
        return this.getDisplayName() + ChatFormatting.DARK_GRAY + (this.getDisplayInfo() != null ? " [" + ChatFormatting.DARK_GRAY + this.getDisplayInfo() + ChatFormatting.DARK_GRAY + "]" : "");
    }
