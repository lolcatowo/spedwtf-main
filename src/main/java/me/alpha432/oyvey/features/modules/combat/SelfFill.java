...
public class SelfFill extends Module {
    ...
    public SelfFill() {
        super("HighPingBurrow", "SelfFills yourself in a hole.", Module.Category.COMBAT, true, false, true);
    }
    ...
    public void onEnable() {
        ...
        if (toggleRStep.getValue()) {
            Sped.moduleManager.getModuleByName("ReverseStep").isEnabled(); {
    ...
    public void onDisable() {
        if (toggleRStep.getValue()) {
            Sped.moduleManager.getModuleByName("ReverseStep").isDisabled(); {
