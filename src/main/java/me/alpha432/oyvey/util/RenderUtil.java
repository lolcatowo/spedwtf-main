...
public class RenderUtil implements Util
{
    ...
    public static void drawGradientRect(final float x, final float y, final float w, final float h, final int color) {
        final float alpha = (color >> 24 & 0xFF) / 255.0f;
        final float red = (color >> 16 & 0xFF) / 255.0f;
        final float green = (color >> 8 & 0xFF) / 255.0f;
        final float blue = (color & 0xFF) / 255.0f;
    ...
    public static void drawText(final BlockPos pos, final String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-(Sped.textManager.getStringWidth(text) / 2.0), 0.0, 0.0);
        Sped.textManager.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        GlStateManager.popMatrix();
    }
