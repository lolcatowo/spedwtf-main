...
public class GuiUtil {
    public static void drawString(String paramString, float paramFloat1, float paramFloat2, int paramInt) {
        if (Sped.moduleManager.getModuleByName("CustomFont").isEnabled()) {
            Sped.fontRenderer.drawStringWithShadow(paramString, paramFloat1, paramFloat2, paramInt);
        } else {
    ...
    public static void drawString(String paramString, int paramInt1, int paramInt2, int paramInt3) {
        if (Sped.moduleManager.getModuleByName("CustomFont").isEnabled()) {
            Sped.fontRenderer.drawStringWithShadow(paramString, paramInt1, paramInt2, paramInt3);
        } else {
    ...
    public static String getCFont() {
        return Sped.fontRenderer.getFont().getFamily();
    }
    ...
    public static int getHeight() {
        return Sped.moduleManager.getModuleByName("CustomFont").isEnabled() ? Sped.fontRenderer.getHeight() : Sped.fontRenderer.getHeight();
    }
    ...
    public static void drawCenteredString(String paramString, int paramInt1, int paramInt2, int paramInt3) {
        if (Sped.moduleManager.getModuleByName("CustomFont").isEnabled()) {
            Sped.fontRenderer.drawStringWithShadow(paramString, (paramInt1 - Sped.fontRenderer.getStringWidth(paramString) / 2), paramInt2, paramInt3);
        } else {
            Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(paramString, (paramInt1 - Sped.fontRenderer.getStringWidth(paramString) / 2), paramInt2, paramInt3);
        }
    }
}
